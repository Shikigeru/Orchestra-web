...
class Contacts extends React.Component {
  ...
  render() {
    ...
    const contentText = {
      ...
      socialMedia:
        lang === "us" ? "Follow us on social media" : "Ми у соцмережах",
        ...
        <div className="main__inner">
          <div className="contacts">
            <div className="dsst-logo">
              <h2 className="medium-title">{contentText.serviceName}</h2>
              <img src="/images/DSST.png" alt="dsst" />
            </div>
            <div className="contacts__info secondary-bg">
              <h2 className="medium-title">{contentText.contacts}</h2>
              <div className="row">
                <div className="col-md-8 cont-col">
                  ...
                  <h2 className="medium-title">{contentText.socialMedia}</h2>
                ...
                <div className="col-md-12">
                  <h2 className="medium-title coords">{contentText.coords}</h2>
                  <iframe
                    className="map"
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2484.085041871786!2d31.279053115769383!3d51.493306879632804!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x46d5489151174ba9%3A0x4bd345848d56e761!2z0YPQuy4g0JjQstCw0L3QsCDQnNCw0LfQtdC_0YssIDE4LCDQp9C10YDQvdC40LPQvtCyLCDQp9C10YDQvdC40LPQvtCy0YHQutCw0Y8g0L7QsdC70LDRgdGC0YwsIDE0MDM5!5e0!3m2!1sru!2sua!4v1553866863930!5m2!1sru!2sua"
                    width="100%"
                    height="450"
                    title="map"
                  />
