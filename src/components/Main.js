        ...
        <div className="main__inner">
          ...
          {lang === "us" ? (
            <div className="main__text">
              ...
              <p>
                Since the beginning of the formation and for today, the
                orchestra has led by 8 military conductors. The creative team
                are well known not only in Chernihiv, but also far beyond its
                borders. Almost all state events and military ceremonies of our
                state do not pass without bright performances of our collective.
                With its highly artistic inputs to the Ukrainian audience, as
                well as on the scenes of the states of the world, the collective
                gained recognition of the demanding audience of the
            ...
            <div className="main__text">
              ...
              <p>
                З перших днів існування частини започаткував свою творчу
                біографію і військовий оркестр. Народжений в 1950 році колектив
                почав великий творчий шлях, з честю виконуючи відповідальні
                завдання культурного обслуговування та естетичного виховання
                військовослужбовців.
              </p>
              <p>
                ...
                Чернігові, а й далеко за його межами. Майже всі урочисті заходи
                та військові церемоніали нашої Держави не проходять без яскравих
